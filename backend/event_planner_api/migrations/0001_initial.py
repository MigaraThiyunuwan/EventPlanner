# Generated by Django 5.0 on 2024-01-29 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productType', models.CharField(choices=[('PH', 'Photography'), ('CA', 'Catering'), ('DE', 'Decoration'), ('MU', 'Music')], default='PH', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='UpdateUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(blank=True, related_name='orders', to='event_planner_api.product')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='event_planner_api.product')),
            ],
        ),
    ]
